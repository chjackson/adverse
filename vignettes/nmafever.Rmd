...
mod.trt <- mtc.model(net.trt, type="grouptreat", likelihood="cjbinom", link="logit", basetrt="103")
mod.drugdm <- mtc.model(net.drugdm, type="grouptreat", likelihood="cjbinom", link="logit", basetrt="Observation")
mod.drug <- mtc.model(net.drug, type="grouptreat", likelihood="cjbinom", link="logit", basetrt="Observation")
mod.drugclass <- mtc.model(net.drugclass, type="grouptreat", likelihood="cjbinom", link="logit", basetrt="Observation")
...
TODO did I forget to sample the random treatment effects. does this even matter? 
haven't illustrated heterogeneity in treatment effects 
...
* assess if _relative_ effects vary between additional treatments.  illustrate heterogeneity in relative effects


more formal checking of NMA model assumptions 
