...
load(file="ors.rda")
```	
## Musculoskeletal pain/event

```{r, warning=FALSE}
arrfn("MUSCULOSKELETAL PAIN/EVENT")
```
...
For the event MUSCULOSKELETAL PAIN/EVENT, observation-only and placebo are considered separately.
