...
Proportion of potential comparisons with direct data: 0.15

Proportion of treatments compared to more than one other: 0.56

Median number of studies per direct comparison: 2 (interquartile range 1-2)

Proportion of direct comparisons informed by more than one study: 0.56
...
For the event ARTHRALGIA, observation-only and placebo are considered separately.
