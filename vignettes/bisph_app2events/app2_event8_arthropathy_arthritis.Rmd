...
```{r, warning=FALSE}
arrfn("arthropathy/arthritis")
```

### Network geometry summary

Proportion of potential comparisons with direct data: 0.2

Proportion of treatments compared to more than one other: 0.58

Median number of studies per direct comparison: 1 (interquartile range 1-1)

Proportion of direct comparisons informed by more than one study: 0.23
...
For the event arthropathy/arthritis, observation-only and placebo are considered separately.
