...
Proportion of potential comparisons with direct data: 0.3

Proportion of treatments compared to more than one other: 0.2
...
For the event VAGINAL BLEEDING, observation-only and placebo are considered separately.
