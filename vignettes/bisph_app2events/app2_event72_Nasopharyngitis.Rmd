...
```{r, warning=FALSE}
arrfn("Nasopharyngitis")
```

### Network geometry summary

Proportion of potential comparisons with direct data: 0.8

Proportion of treatments compared to more than one other: 1
...
For the event Nasopharyngitis, observation-only and placebo are considered separately.
