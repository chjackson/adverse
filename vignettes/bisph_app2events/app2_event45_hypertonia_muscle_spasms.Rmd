...
```{r, warning=FALSE}
arrfn("hypertonia/muscle spasms")
```
...
Proportion of treatments compared to more than one other: 0.44

Median number of studies per direct comparison: 1 (interquartile range 1-1)

Proportion of direct comparisons informed by more than one study: 0.12
...
For the event hypertonia/muscle spasms, observation-only and placebo are considered separately.
