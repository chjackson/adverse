...
```{r, warning=FALSE}
arrfn("CARDIAC: CONGESTIVE HEART FAILURE")
```
...
Proportion of direct comparisons informed by more than one study: 0.2
...
For the event CARDIAC: CONGESTIVE HEART FAILURE, observation-only and placebo are considered separately.
