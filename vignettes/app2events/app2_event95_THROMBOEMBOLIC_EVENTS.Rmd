...
Proportion of treatments compared to more than one other: 0.55

Median number of studies per direct comparison: 1 (interquartile range 1-1)

Proportion of direct comparisons informed by more than one study: 0.25
...
For the event THROMBOEMBOLIC EVENTS, observation-only and placebo are considered separately.
