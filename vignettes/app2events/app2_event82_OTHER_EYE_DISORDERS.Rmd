...
Proportion of treatments compared to more than one other: 0.46

Median number of studies per direct comparison: 1 (interquartile range 1-3)

Proportion of direct comparisons informed by more than one study: 0.36
...
For the event OTHER EYE DISORDERS, observation-only and placebo are considered separately.
