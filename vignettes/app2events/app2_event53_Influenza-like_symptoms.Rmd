...
```{r, warning=FALSE}
arrfn("Influenza-like symptoms")
```

### Network geometry summary

Proportion of potential comparisons with direct data: 0.18

Proportion of treatments compared to more than one other: 0.4

Median number of studies per direct comparison: 2 (interquartile range 1-2)

Proportion of direct comparisons informed by more than one study: 0.5
...
For the event Influenza-like symptoms, observation-only and placebo are considered separately.
