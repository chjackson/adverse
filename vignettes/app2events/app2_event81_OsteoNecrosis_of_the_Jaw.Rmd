...
Proportion of potential comparisons with direct data: 0.13

Proportion of treatments compared to more than one other: 0.47

Median number of studies per direct comparison: 1 (interquartile range 1-3)

Proportion of direct comparisons informed by more than one study: 0.43
...
For the event OsteoNecrosis of the Jaw, observation-only and placebo are considered separately.
