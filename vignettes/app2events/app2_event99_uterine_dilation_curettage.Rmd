...
load(file="ors.rda")
```	
## uterine dilation/curettage

```{r, warning=FALSE}
arrfn("uterine dilation/curettage")
```
...
For the event uterine dilation/curettage, observation-only and placebo are considered separately.
