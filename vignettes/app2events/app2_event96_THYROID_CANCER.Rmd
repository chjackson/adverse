...
```{r, warning=FALSE}
arrfn("THYROID CANCER")
```

### Network geometry summary

Proportion of potential comparisons with direct data: 0.67

Proportion of treatments compared to more than one other: 0.33
...
For the event THYROID CANCER, observation-only and placebo are considered separately.
