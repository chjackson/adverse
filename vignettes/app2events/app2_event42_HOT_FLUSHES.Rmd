...
Proportion of potential comparisons with direct data: 0.21

Proportion of treatments compared to more than one other: 0.57

Median number of studies per direct comparison: 1 (interquartile range 1-4)

Proportion of direct comparisons informed by more than one study: 0.32
...
For the event HOT FLUSHES, observation-only and placebo are considered separately.
