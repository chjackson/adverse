...
Proportion of potential comparisons with direct data: 0.14

Proportion of treatments compared to more than one other: 0.61

Median number of studies per direct comparison: 1 (interquartile range 1-2)

Proportion of direct comparisons informed by more than one study: 0.38
...
For the event DIARRHOEA, observation-only and placebo are considered separately.
