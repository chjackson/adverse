...
Proportion of treatments compared to more than one other: 0.45

Median number of studies per direct comparison: 1 (interquartile range 1-2)

Proportion of direct comparisons informed by more than one study: 0.45
...
For the event NEUTROPENIA, observation-only and placebo are considered separately.
