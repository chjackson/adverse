...
```{r, warning=FALSE}
arrfn("FEBRILE NEUTROPENIA")
```

### Network geometry summary

Proportion of potential comparisons with direct data: 0.25

Proportion of treatments compared to more than one other: 0.38
...
For the event FEBRILE NEUTROPENIA, observation-only and placebo are considered separately.
